...
export const AgentZeroCard = ({ className, compact }: AgentZeroCardProps) => {
    ...
    return (
        <Card
            className={cn("nerv-glass-1 nerv-glow-border flex flex-col", className)}
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center gap-2">
                            <span className="nerv-h2">Agent Zero</span>
                            <Badge
                                variant="outline"
                                style={{
                        ...
                        <span className="nerv-caption">Socket.IO • REST API</span>
                    </div>
                </div>
                        ...
                        {status === 'online' ? (
                                        ...
                                        {messages.length === 0 ? (
                                            ...
                                            <AnimatePresence>
                                                {messages.map((msg) => (
                                                    ...
                                                    >
                                                        <span className="nerv-body-sm leading-relaxed whitespace-pre-wrap">{msg.content}</span>
                                                        <span className="nerv-caption text-[9px] mt-1.5 opacity-40 uppercase tracking-widest">
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center gap-4 bg-black/20 rounded-md border border-white/5">
                                ...
                                <div className="flex flex-col gap-1">
                                    <span className="nerv-body font-medium">Agent Zero Offline</span>
                                    <span className="nerv-caption text-muted-foreground max-w-[200px]">Waiting for connection to the Agent Zero VPS. Ensure URL and API Key are set in .env.local</span>
                                </div>
