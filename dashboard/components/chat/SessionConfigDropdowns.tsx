            ...
            {activeConfigs.thinking && (
                <div className="relative group/btn flex items-center">
                    <DropdownMenu defaultOpen={autoOpenConfig === 'thinking'}>
                        <DropdownMenuTrigger asChild>
                            <button
                                ...
                                className={cn(
                                    ...
                                    thinking !== 'inherit' ? "border-[var(--nerv-violet)] text-[var(--nerv-violet)]" : "border-border text-muted-foreground",
                        ...
                        <DropdownMenuContent side="top" align="center" className="min-w-0 w-32 pb-1 mb-1 nerv-glass-3">
