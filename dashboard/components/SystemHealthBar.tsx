...
const VpsIndicator = memo(({ label, connected, connecting }: {
    ...
    return (
        <div className="flex items-center gap-1.5">
            ...
            />
            <span className="nerv-caption text-muted-foreground">{label}</span>
        </div>
    );
});
        ...
        return (
            <div className={cn("flex flex-col gap-2 w-full", className)}>
                ...
                <div className="flex items-center justify-between">
                    <span className="nerv-caption text-muted-foreground opacity-50">Awaiting telemetry...</span>
                    {showVpsIndicators && (
    ...
    return (
        <div className={cn("flex flex-col gap-2 w-full", className)}>
            ...
            <div className="flex items-center justify-between">
                <div>
                    {isAllHealthy ? (
                        <span className="nerv-caption" style={{ color: 'var(--accent-lime)' }}>All systems nominal</span>
                    ) : (
                        <span className="nerv-caption" style={{ color: 'var(--accent-coral)' }}>
