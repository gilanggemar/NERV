                    ...
                    <div className={cn("flex flex-col gap-3 font-sans w-fit", className)}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-baseline gap-2">
                                <motion.span
                                    className="nerv-metric-xl tabular-nums leading-none"
                                ...
                                <span className="nerv-body-sm opacity-50 relative top-[-2px]">
                        ...
                        <div className="flex flex-col gap-1.5 pl-1.5">
                            ...
                            <div className="flex items-center gap-1.5 relative left-[-2px]">
                                {weekDays.map((day, i) => (
                                    <span key={i} className="nerv-caption opacity-40 w-[10px] text-center" style={{ fontSize: '9px' }}>
                                        {day}
                                    </span>
                                ))}
                            </div>
                        ...
                        {!isEmpty && (
                            <div className="pl-1.5 mt-1">
                                {isBest ? (
                                    <span className="nerv-caption" style={{ color: 'var(--accent-lime)' }}>
                                        🏆 Personal best!
                                    </span>
                                ) : (longestStreak > currentStreak && (
                                    <span className="nerv-caption opacity-50">
