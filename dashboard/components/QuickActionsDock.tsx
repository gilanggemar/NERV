...
export const QuickActionsDock = () => {
    ...
    return (
        <motion.div
            ...
            className="hidden md:flex fixed bottom-[20px] left-1/2 -translate-x-1/2 z-50 rounded-full px-3 py-1.5 nerv-glass-3 gap-1 shadow-[inset_0_1px_0_oklch(1_0_0/0.08)]"
        >
            <TooltipProvider delayDuration={200}>
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="top" className="hidden lg:block nerv-caption text-foreground bg-popover/90 backdrop-blur-md mb-2">
                ...
                <AlertDialog>
                    ...
                    <AlertDialogContent className="nerv-glass-3 border-[var(--accent-coral-soft)] shadow-[0_0_40px_oklch(from_var(--accent-coral)_l_c_h/0.2)]">
                        <AlertDialogHeader>
                            <AlertDialogTitle className="nerv-h2 flex items-center gap-2 text-[var(--accent-coral)]">
                                <ShieldAlert size={24} />
                                Emergency Shutdown
                            </AlertDialogTitle>
                            <AlertDialogDescription className="nerv-body text-foreground/80">
